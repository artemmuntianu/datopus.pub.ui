...
export class ReportsFeaturesFlowService extends BaseApiService {

    constructor(private sbService: SupabaseService) {
        super();
    }

    async getStats(from: Date, to: Date, datasourceIds: number[], cols: string[], metric: string, dimIds?: { [key: string]: string[] }) {
